...
function updateUserBooks(userID) {
    $.ajax({
        type: 'GET',
        url: 'http://localhost:8090/users?id=' + userID,
        dataType: 'json',
        ...
        success: function (data) {
            ...
            // container.hide(0);
            container.empty();
            message_data += "<table id=\"users_table\" class=\"table table-hover table-responsive table-condensed table-striped\">";
            message_data += "<thead>";
            message_data += "<tr>";
            ...
            $.each(data, function (key, value) {
                ...
                let bookURL = 'http://localhost:8090/books?id=' + value.id;
                console.log(bookURL);
