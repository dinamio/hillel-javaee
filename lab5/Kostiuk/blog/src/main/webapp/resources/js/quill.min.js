...
!function (t, e) {
    ...
    return function (t) {
        ...
        S.DEFAULTS = {
            ...
            strict: !0,
            theme: "default"
        }, S.events = g.default.events, S.sources = g.default.sources, S.version = "1.3.3", S.imports = {
            delta: d.default,
            parchment: w.default,
        ...
        var r = n(0), o = function (t) {
                return t && t.__esModule ? t : {default: t}
            }(r), i = n(25), l = new o.default.Attributor.Class("background", "ql-bg", {scope: o.default.Scope.INLINE}),
        ...
        function h(t, e) {
            ...
            this.quill.insertText(t.index, "\n", r, L.default.sources.USER), this.quill.setSelection(t.index + 1, L.default.sources.SILENT), this.quill.focus(), Object.keys(e.format).forEach(function (t) {
                null == r[t] && (Array.isArray(e.format[t]) || "link" !== t && n.quill.format(t, e.format[t], L.default.sources.USER))
            })
        }

        function p(t) {
            return {
                key: F.keys.TAB, shiftKey: !t, format: {"code-block": !0}, handler: function (e) {
        ...
        function d(t) {
            return {
                key: t[0].toUpperCase(), shortKey: !0, handler: function (e, n) {
                    this.quill.format(t, !n.format[t], L.default.sources.USER)
                }
            }
        }
        ...
        function y(t) {
            ...
            if ("object" === (void 0 === t ? "undefined" : v(t)) && (t = (0, _.default)(t, !1)), "string" == typeof t.key) if (null != F.keys[t.key.toUpperCase()]) t.key = F.keys[t.key.toUpperCase()]; else {
        ...
        var v = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            q = n(0), T = r(q), P = n(24), S = r(P), C = n(6), L = r(C), M = n(10), R = r(M), I = n(7), B = r(I),
            D = (0, R.default)("quill:keyboard"), U = /Mac/i.test(navigator.platform) ? "metaKey" : "ctrlKey",
            F = function (t) {
                function e(t, n) {
                    i(this, e);
        ...
        F.keys = {
            ...
            bindings: {
                ...
                indent: {
                    key: F.keys.TAB, format: ["blockquote", "indent", "list"], handler: function (t, e) {
                ...
                "outdent backspace": {
                    ...
                    offset: 0,
                    handler: function (t, e) {
                        null != e.format.indent ? this.quill.format("indent", "-1", L.default.sources.USER) : null != e.format.list && this.quill.format("list", !1, L.default.sources.USER)
                    }
                },
                "indent code-block": p(!0),
                "outdent code-block": p(!1),
                "remove tab": {
                    key: F.keys.TAB, shiftKey: !0, collapsed: !0, prefix: /\t$/, handler: function (t) {
                        this.quill.deleteText(t.index - 1, 1, L.default.sources.USER)
                    }
                },
                tab: {
                    key: F.keys.TAB, handler: function (t) {
                ...
                "list empty enter": {
                    ...
                    empty: !0,
                    handler: function (t, e) {
                        this.quill.format("list", !1, L.default.sources.USER), e.format.indent && this.quill.format("indent", !1, L.default.sources.USER)
                    }
                },
                "checklist enter": {
                    key: F.keys.ENTER, collapsed: !0, format: {list: "checked"}, handler: function (t) {
        ...
        var u = function () {
                ...
                var l = o.get;
                if (void 0 !== l) return l.call(r)
            }, f = n(2), h = r(f), p = n(4), d = r(p), y = n(9), v = r(y), b = n(38), g = r(b), m = n(32), _ = r(m),
        ...
        var o = n(46), i = r(o), l = n(33), a = n(35), s = n(62), u = n(63), c = r(u), f = n(64), h = r(f), p = n(65),
            d = r(p), y = n(34), v = n(25), b = n(36), g = n(37), m = n(39), _ = r(m), O = n(66), w = r(O), x = n(15),
        ...
        var o = n(0), i = r(o), l = n(6), a = r(l), s = n(3), u = r(s), c = n(14), f = r(c), h = n(23), p = r(h),
            d = n(31), y = r(d), v = n(24), b = r(v), g = n(5), m = r(g), _ = n(59), O = r(_), w = n(8), x = r(w),
            k = n(60), E = r(k), N = n(61), j = r(N), A = n(38), q = r(A);
        a.default.register({
        ...
        function r(t, e) {
            ...
            if (-1 != a) return r = [[d, i.substring(0, a)], [y, l], [d, i.substring(a + l.length)]], t.length > e.length && (r[0][0] = r[2][0] = p), r;
            if (1 == l.length) return [[p, t], [d, e]];
            var u = s(t, e);
            if (u) {
                var c = u[0], f = u[1], h = u[2], v = u[3], b = u[4], g = n(c, h), m = n(f, v);
        ...
        function o(t, e) {
            ...
            for (var f = n - r, h = f % 2 != 0, y = 0, v = 0, b = 0, g = 0, m = 0; m < o; m++) {
                for (var _ = -m + y; _ <= m - v; _ += 2) {
                    ...
                    if (s[w] = O, O > n) v += 2; else if (x > r) y += 2; else if (h) {
                        var k = l + f - _;
                        if (k >= 0 && k < a && -1 != u[k]) {
                            var E = n - u[k];
        ...
        var p = -1, d = 1, y = 0, v = n;
        v.INSERT = d, v.DELETE = p, v.EQUAL = y, t.exports = v
    }, function (t, e) {
        function n(t) {
            var e = [];
        ...
        var x = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            R = n(7), I = r(R), B = n(33), D = n(34), U = n(13), F = r(U), H = n(25), K = n(35), z = n(36), Z = n(37),
        ...
        var a = function () {
            ...
            var l = o.get;
            if (void 0 !== l) return l.call(r)
        }, u = n(24), c = r(u), f = n(6), h = r(f), p = n(7), d = r(p), y = function (t) {
            function e() {
                return o(this, e), i(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
            }
