...
import com.hillel.dao.impl.JDBCBookDao;
...
public class BookServlet extends HttpServlet {
    ...
    public BookServlet() {
        jdbcBookDao = JDBCBookDao.getInstance();
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (id != -1) {
            jdbcBookDao.getBookById(id).ifPresent(book -> {
        ...
        List<Book> books = jdbcBookDao.getAllBooks();
...
//                .image(image)
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        Utils.requestID(req).ifPresent(jdbcBookDao::deleteBookById);
